...
int getImageBlocks(initialParams* ct, PPMImageParams* imageParams, PPMBlock* block, int numBlock)
{
    ...
    if (strcmp(imageParams->tipo, "P6")==0)
        ...
        block[numBlock].teste2 = (PPMBlock *)malloc(imageParams->coluna * linhas * sizeof(unsigned char));
    ...
    if (strcmp(imageParams->tipo, "P6")==0)
        ...
        block[numBlock].teste = malloc(imageParams->coluna * linhas * sizeof(unsigned char));
